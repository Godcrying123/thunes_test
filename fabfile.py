...
env.PROJECT_NAME = 'thunes'
env.SETTINGS_BASE = 'thunes/thunes/settings/base.py'

env.DEPLOY_PATH = '/root/PycharmProjects/thunes/venv'
...
def build(version=None):
    """
    build on local environment and upload it to PYPI server
    1. Configure the package version
...
def deploy(version, profile):
    """ Deploy the appointed version
    1. Ensure the virtual Environment has been configured
